 ...
 * CheckboxField对象构造方法
 */
hait.form.field.CheckboxField = function() {
	/**
	 * 放置事件对象
	 */
...
hait.form.field.CheckboxField.inherit(hait.form.Field);
 ...
 * @param obj
 */
hait.form.field.CheckboxField.prototype.convert = function(obj) {
	// 调用父级方法convert
 ...
 * 直接创建的方法
 */
hait.form.field.CheckboxField.prototype.draw = function() {
	var _this = this;
	// 调用父级方法convert
	this.father(hait.form.Field, "draw");

	var container = $("<label><input type='checkbox' id='input_checkbox_" + this.id + "'/>" + this.text + "</label>");
 ...
 * 实现getValue操作
 */
hait.form.field.CheckboxField.prototype.getValue = function() {
 ...
 * @returns
 */
hait.form.field.CheckboxField.prototype.isChecked = function() {
 ...
 * @param val
 */
hait.form.field.CheckboxField.prototype.setValue = function(val) {
	this.value = val;
	switch (parseInt(this.value)) {
	case 1:
		this.obj.find("input")[0].checked = true;
		break;
	case 2:
		this.obj.find("input")[0].checked = false;
		break;
	}
};

hait.form.field.CheckboxField.prototype.setReadonly = function(isReadonly) {
...
hait.form.field.CheckboxField.prototype.setDisabled = function(isDisabled) {
