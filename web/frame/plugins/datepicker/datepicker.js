...
(function (factory) {
  ...
  Datepicker.prototype = {
    ...
    build: function () {
      ...
      // 选择按钮
      this.$buttons = $picker.find('[data-view="button"]');
      var _this = this;
      this.$buttons.find("button:eq(0)").click(function(){
    	  var curDate = new Date();
          var year = curDate.getFullYear();
          var month = curDate.getMonth() + 1;
          month = month < 10 ? "0" + month : month;
          var day = curDate.getDate() < 10 ? "0" + curDate.getDate() : curDate.getDate();
          var curDateShow = year + "-" + month + "-" + day;
    	  _this.setDate(curDateShow, true);
    	  _this.setValue(curDateShow);
    	  _this.hide();
    	  // 启动pick事件
    	  _this.trigger(EVENT_PICK, {
  	        date: curDate
  	      }).isDefaultPrevented()
      });
      this.$buttons.find("button:eq(1)").click(function(){
    	  // 启动pick事件
    	  _this.trigger(EVENT_PICK, {
  	        date: null
  	      }).isDefaultPrevented()
    ...
    template: (
      '<div class="datepicker-container">' +
        ...
        '<div class="datepicker-panel" data-view="days picker">' +
          ...
          '<div data-view="button"><button>今天</button><button>清空</button></div>' +
        '</div>' +
      '</div>'
    ),
