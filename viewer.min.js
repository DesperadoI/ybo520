 ...
 */
!function (t, i) {
    "object" == typeof exports && "undefined" != typeof module ? module.exports = i() : "function" == typeof define && define.amd ? define(i) : (t = t || self).Viewer = i()
}(this, function () {
    "use strict";
    ...
    var s = {
            ...
            zoom: null,
            zoomed: null
        }, o = "undefined" != typeof window, a = o ? window : {}, r = o && "ontouchstart" in a.document.documentElement,
        t = o && "PointerEvent" in a, p = "viewer", h = "move", l = "switch", c = "zoom", f = "".concat(p, "-active"),
        w = "".concat(p, "-close"), b = "".concat(p, "-fade"), y = "".concat(p, "-fixed"),
        x = "".concat(p, "-fullscreen"), u = "".concat(p, "-fullscreen-exit"), k = "".concat(p, "-hide"),
        e = "".concat(p, "-hide-md-down"), d = "".concat(p, "-hide-sm-down"), m = "".concat(p, "-hide-xs-down"),
        g = "".concat(p, "-in"), z = "".concat(p, "-invisible"), v = "".concat(p, "-loading"),
        D = "".concat(p, "-move"), T = "".concat(p, "-open"), E = "".concat(p, "-show"),
        I = "".concat(p, "-transition"), S = "click", C = "dblclick", L = "dragstart", N = "hidden", R = "hide",
        M = "keydown", Y = "load", q = t ? "pointerdown" : r ? "touchstart" : "mousedown",
        X = t ? "pointermove" : r ? "touchmove" : "mousemove",
        F = t ? "pointerup pointercancel" : r ? "touchend touchcancel" : "mouseup", O = "ready", A = "resize",
        W = "show", P = "shown", H = "transitionend", j = "view", V = "viewed", B = "wheel", K = "".concat(p, "Action"),
        U = /\s\s*/,
        Z = ["zoom-in", "zoom-out", "one-to-one", "reset", "prev", "play", "next", "rotate-left", "rotate-right", "flip-horizontal", "flip-vertical"];
    ...
    function it(t) {
        ...
        try {
            ...
            return i && e && tt.call(e, "isPrototypeOf")
        } catch (t) {
            return !1
        }
    }
    ...
    function nt(i, e) {
        if (i && et(e)) if (Array.isArray(i) || G(i.length)) {
            var t, n = i.length;
            for (t = 0; t < n && !1 !== e.call(i, i[t], t, i); t += 1) ;
        } else Q(i) && Object.keys(i).forEach(function (t) {
            e.call(i, i[t], t, i)
        });
        return i
    }
    ...
    var st = Object.assign || function (e) {
        ...
        return Q(e) && 0 < i.length && i.forEach(function (i) {
            Q(i) && Object.keys(i).forEach(function (t) {
                e[t] = i[t]
            })
        }), e
    ...
    function at(t, i) {
        var e = t.style;
        nt(i, function (t, i) {
            ot.test(i) && G(t) && (t += "px"), e[i] = t
        })
    }

    function rt(t) {
        return $(t) ? t.replace(/&(?!amp;|quot;|#39;|lt;|gt;)/g, "&amp;").replace(/"/g, "&quot;").replace(/'/g, "&#39;").replace(/</g, "&lt;").replace(/>/g, "&gt;") : t
    }

    function ht(t, i) {
        return t.classList ? t.classList.contains(i) : -1 < t.className.indexOf(i)
    }

    function lt(t, i) {
        if (i) if (G(t.length)) nt(t, function (t) {
            lt(t, i)
    ...
    function ft(t, i) {
        return Q(t[i]) ? t[i] : t.dataset ? t.dataset[i] : t.getAttribute("data-".concat(mt(i)))
    }

    function gt(t, i, e) {
        Q(e) ? t[i] = e : t.dataset ? t.dataset[i] = e : t.setAttribute("data-".concat(mt(i)), e)
    }
    ...
    var vt = function () {
        ...
        if (o) {
            ...
            a.addEventListener("test", e, n), a.removeEventListener("test", e, n)
        }
        return t
    }();
    ...
    function pt(e, t, n, i) {
        ...
        t.trim().split(U).forEach(function (t) {
            if (!vt) {
                var i = e.listeners;
    ...
    function wt(o, t, a, i) {
        ...
        t.trim().split(U).forEach(function (n) {
            if (r.once && !vt) {
    ...
    function bt(t, i, e) {
        var n;
        return et(Event) && et(CustomEvent) ? n = new CustomEvent(i, {
            detail: e,
            bubbles: !0,
            cancelable: !0
    ...
    var xt = a.navigator && /(Macintosh|iPhone|iPod|iPad).*AppleWebKit/i.test(a.navigator.userAgent);
    ...
    function Dt(t, i) {
        ...
        return i ? s : st({timeStamp: Date.now(), startX: e, startY: n}, s)
    }
    ...
    var Tt = {
        render: function () {
            ...
            nt(this.images, function (t, i) {
                var e = t.src, n = rt(t.alt || function (t) {
                    return $(t) ? decodeURIComponent(t.replace(/^.*\//, "").replace(/[?&#].*$/, "")) : ""
                }(e)), s = h.url;
                if ($(s) ? s = t.getAttribute(s) : et(s) && (s = s.call(r, t)), e || s) {
                    var o = document.createElement("li"), a = document.createElement("img");
                    a.src = e || s, a.alt = n, a.setAttribute("data-index", i), a.setAttribute("data-original-url", s || e), a.setAttribute("data-viewer-action", "view"), a.setAttribute("role", "button"), o.appendChild(a), l.appendChild(o), c.push(o)
                }
            }), nt(this.items = c, function (i) {
                var t = i.firstElementChild;
                gt(t, "filled", !0), h.loading && lt(i, v), wt(t, Y, function (t) {
                    h.loading && ct(i, v), r.loadImage(t)
                }, {once: !0})
            }), h.transition && wt(t, V, function () {
                lt(l, I)
            }, {once: !0})
        }, renderList: function (t) {
            var i = t || this.index, e = this.items[i].offsetWidth || 30, n = e + 1;
            at(this.list, st({width: n * this.length}, yt({translateX: (this.viewerData.width - e) / 2 - n * i})))
        }, resetList: function () {
            var t = this.list;
            t.innerHTML = "", ct(t, I), at(t, yt({translateX: 0}))
        ...
        bind: function () {
            ...
            wt(i, S, this.onClick = this.click.bind(this)), wt(i, B, this.onWheel = this.wheel.bind(this), {
                passive: !1,
                capture: !0
            }), wt(i, L, this.onDragStart = this.dragstart.bind(this)), wt(e, q, this.onPointerDown = this.pointerdown.bind(this)), wt(n, X, this.onPointerMove = this.pointermove.bind(this)), wt(n, F, this.onPointerUp = this.pointerup.bind(this)), wt(n, M, this.onKeyDown = this.keydown.bind(this)), wt(window, A, this.onResize = this.resize.bind(this)), t.toggleOnDblclick && wt(e, C, this.onDblclick = this.dblclick.bind(this))
        }, unbind: function () {
            var t = this.options, i = this.viewer, e = this.canvas, n = this.element.ownerDocument;
            pt(i, S, this.onClick), pt(i, B, this.onWheel, {
                passive: !1,
                capture: !0
            }), pt(i, L, this.onDragStart), pt(e, q, this.onPointerDown), pt(n, X, this.onPointerMove), pt(n, F, this.onPointerUp), pt(n, M, this.onKeyDown), pt(window, A, this.onResize), t.toggleOnDblclick && pt(e, C, this.onDblclick)
        }
    }, It = {
        click: function (t) {
            var i = t.target, e = this.options, n = this.imageData, s = ft(i, K);
            switch (r && t.isTrusted && i === this.canvas && clearTimeout(this.clickCanvasTimeout), s) {
                case"mix":
            ...
            t.preventDefault(), this.viewed && t.target === this.image && (r && t.isTrusted && clearTimeout(this.doubleClickImageTimeout), this.toggle())
        }, load: function () {
            var t = this;
            this.timeout && (clearTimeout(this.timeout), this.timeout = !1);
            var i = this.element, e = this.options, n = this.image, s = this.index, o = this.viewerData;
            ct(n, z), e.loading && ct(this.canvas, v), n.style.cssText = "height:0;" + "margin-left:".concat(o.width / 2, "px;") + "margin-top:".concat(o.height / 2, "px;") + "max-width:none!important;position:absolute;width:0;", this.initImage(function () {
                ut(n, D, e.movable), ut(n, I, e.transition), t.renderImage(function () {
                    t.viewed = !0, t.viewing = !1, et(e.viewed) && wt(i, V, e.viewed, {once: !0}), bt(i, V, {
            ...
            kt(o, function (t, i) {
                var e = t / i, n = a, s = r;
                a < r * e ? h ? n = r * e : s = a / e : h ? s = a / e : n = r * e, at(o, st({
                    width: n,
                    height: s
            ...
            if (!(!this.viewed || this.showing || this.viewing || this.hiding || G(n) && 1 !== n || G(s) && 0 !== s || t.ctrlKey)) {
                t.preventDefault(), t.changedTouches ? nt(t.changedTouches, function (t) {
                    e[t.identifier] = Dt(t)
                }) : e[t.pointerId || 0] = Dt(t);
                var o = !!i.movable && h;
                1 < Object.keys(e).length ? o = c : "touch" !== t.pointerType && "touchstart" !== t.type || !this.isSwitchable() || (o = l), !i.transition || o !== h && o !== c || ct(this.image, I), this.action = o
            }
        }, pointermove: function (t) {
            var i = this.pointers, e = this.action;
            this.viewed && e && (t.preventDefault(), t.changedTouches ? nt(t.changedTouches, function (t) {
                st(i[t.identifier] || {}, Dt(t, !0))
            }) : st(i[t.pointerId || 0] || {}, Dt(t, !0)), this.change(t))
        }, pointerup: function (t) {
            var i, e = this, n = this.options, s = this.action, o = this.pointers;
            t.changedTouches ? nt(t.changedTouches, function (t) {
            ...
            if (this.isShown && !this.hiding && (this.initContainer(), this.initViewer(), this.renderViewer(), this.renderList(), this.viewed && this.initImage(function () {
                ...
                nt(this.player.getElementsByTagName("img"), function (t) {
                    wt(t, Y, i.loadImage.bind(i), {once: !0}), bt(t, Y)
                })
            }
        }, wheel: function (t) {
            var i = this;
        ...
        show: function (t) {
            ...
            if (et(n.show) && wt(e, W, n.show, {once: !0}), !1 === bt(e, W) || !this.ready) return this;
            ...
            if (ct(s, k), n.transition && !i) {
                ...
                }, lt(s, I), s.offsetWidth, wt(s, H, o, {once: !0}), lt(s, g)
            } else lt(s, g), this.shown();
            return this
        }, hide: function () {
            ...
            if (et(e.hide) && wt(i, R, e.hide, {once: !0}), !1 === bt(i, R)) return this;
            this.showing && this.transitioning.abort(), this.hiding = !0, this.played ? this.stop() : this.viewing && this.viewing.abort();
            var n = this.viewer;
            if (e.transition && !t) {
                var s = this.hidden.bind(this), o = function () {
                    setTimeout(function () {
                        wt(n, H, s, {once: !0}), ct(n, g)
                    }, 0)
                };
                this.transitioning = {
                    abort: function () {
                        this.viewed ? pt(this.image, H, o) : pt(n, H, s)
                    }
                }, this.viewed && ht(this.image, I) ? (wt(this.image, H, o, {once: !0}), this.zoomTo(0, !1, !1, !0)) : o()
            } else ct(n, g), this.hidden();
            return this
        }, view: function (t) {
            var e = this, i = 0 < arguments.length && void 0 !== t ? t : this.options.initialViewIndex;
            if (i = Number(i) || 0, !this.isShown) return this.index = i, this.show();
            if (this.hiding || this.played || i < 0 || i >= this.length || this.viewed && i === this.index) return this;
            this.viewing && this.viewing.abort();
            var n = this.element, s = this.options, o = this.title, a = this.canvas, r = this.items[i],
                h = r.querySelector("img"), l = ft(h, "originalUrl"), c = rt(h.getAttribute("alt")),
                u = document.createElement("img");
            if (u.src = l, u.alt = c, et(s.view) && wt(n, j, s.view, {once: !0}), !1 === bt(n, j, {
                originalImage: this.images[i],
                index: i,
                image: u
            }) || !this.isShown || this.hiding || this.played) return this;
            this.image = u, ct(this.items[this.index], f), lt(r, f), this.viewed = !1, this.index = i, this.imageData = {}, lt(u, z), s.loading && lt(a, v), a.innerHTML = "", a.appendChild(u), this.renderList(), o.innerHTML = "";

            function d() {
                var t = e.imageData, i = Array.isArray(s.title) ? s.title[1] : s.title;
                o.innerHTML = rt(et(i) ? i.call(e, u, t) : "".concat(c, " (").concat(t.naturalWidth, " × ").concat(t.naturalHeight, ")"))
            }

            var m;
            return wt(n, V, d, {once: !0}), this.viewing = {
                abort: function () {
                    pt(n, V, d), u.complete ? this.imageRendering ? this.imageRendering.abort() : this.imageInitializing && this.imageInitializing.abort() : (u.src = "", pt(u, Y, m), this.timeout && clearTimeout(this.timeout))
                }
            }, u.complete ? this.load() : (wt(u, Y, m = this.load.bind(this), {once: !0}), this.timeout && clearTimeout(this.timeout), this.timeout = setTimeout(function () {
                ct(u, z), e.timeout = !1
            }, 1e3)), this
        }, prev: function (t) {
            ...
            var s = this, o = 1 < arguments.length && void 0 !== i && i,
                a = 2 < arguments.length && void 0 !== e ? e : null, r = 3 < arguments.length && void 0 !== n && n,
                h = this.element, l = this.options, c = this.pointers, u = this.imageData, d = u.width, m = u.height,
                f = u.left, g = u.top, v = u.naturalWidth, p = u.naturalHeight;
            if (G(t = Math.max(0, t)) && this.viewed && !this.played && (r || l.zoomable)) {
                if (!r) {
                    var w = Math.max(.01, l.minZoomRatio), b = Math.min(100, l.maxZoomRatio);
                    t = Math.min(Math.max(t, w), b)
                }
                a && .95 < t && t < 1.05 && (t = 1);
                var y = v * t, x = p * t, k = y - d, z = x - m, D = d / v;
                if (et(l.zoom) && wt(h, "zoom", l.zoom, {once: !0}), !1 === bt(h, "zoom", {
                    ratio: t,
                    oldRatio: D,
                    originalEvent: a
                })) return this;
                if (this.zooming = !0, a) {
                    ...
                    }(this.viewer), E = c && Object.keys(c).length ? function (t) {
                        var n = 0, s = 0, o = 0;
                    ...
                    u.left -= k * ((E.pageX - T.left - f) / d), u.top -= z * ((E.pageY - T.top - g) / m)
                } else u.left -= k / 2, u.top -= z / 2;
                u.width = y, u.height = x, u.ratio = t, this.renderImage(function () {
                    s.zooming = !1, et(l.zoomed) && wt(h, "zoomed", l.zoomed, {once: !0}), bt(h, "zoomed", {
                        ratio: t,
                        oldRatio: D,
                        originalEvent: a
                    })
            ...
            if (this.played = !0, this.onLoadWhenPlay = a, t && this.requestFullscreen(), lt(o, E), nt(this.items, function (t, i) {
                var e = t.querySelector("img"), n = document.createElement("img");
                n.src = ft(e, "originalUrl"), n.alt = rt(e.getAttribute("alt")), h += 1, lt(n, b), ut(n, I, s.transition), ht(t, f) && (lt(n, g), l = i), r.push(n), wt(n, Y, a, {once: !0}), o.appendChild(n)
            }), G(s.interval) && 0 < s.interval) {
                var e = function t() {
                    i.playing = setTimeout(function () {
                        ct(r[l], g), lt(r[l = (l += 1) < h ? l : 0], g), t()
                    }, s.interval)
                };
                1 < h && e()
            }
            ...
            var t = this.player;
            return this.played = !1, clearTimeout(this.playing), nt(t.getElementsByTagName("img"), function (t) {
                pt(t, Y, i.onLoadWhenPlay)
            }), ct(t, E), t.innerHTML = "", this.exitFullscreen(), this
        }, full: function () {
            var t = this, i = this.options, e = this.viewer, n = this.image, s = this.list;
            return !this.isShown || this.played || this.fulled || !i.inline || (this.fulled = !0, this.open(), lt(this.button, u), i.transition && (ct(s, I), this.viewed && ct(n, I)), lt(e, y), e.setAttribute("style", ""), at(e, {zIndex: i.zIndex}), this.initContainer(), this.viewerData = st({}, this.containerData), this.renderList(), this.viewed && this.initImage(function () {
            ...
            var t = this, i = this.options, e = this.viewer, n = this.image, s = this.list;
            return this.isShown && !this.played && this.fulled && i.inline && (this.fulled = !1, this.close(), ct(this.button, u), i.transition && (ct(s, I), this.viewed && ct(n, I)), ct(e, y), at(e, {zIndex: i.zIndexInline}), this.viewerData = st({}, this.parentData), this.renderViewer(), this.renderList(), this.viewed && this.initImage(function () {
                t.renderImage(function () {
                    i.transition && setTimeout(function () {
                        lt(n, I), lt(s, I)
                    }, 0)
            ...
            return this.viewed && !this.played && i.tooltip && (e.textContent = "".concat(Math.round(100 * n.ratio), "%"), this.tooltipping ? clearTimeout(this.tooltipping) : i.transition ? (this.fading && bt(e, H), lt(e, E), lt(e, b), lt(e, I), e.offsetWidth, lt(e, g)) : lt(e, E), this.tooltipping = setTimeout(function () {
                i.transition ? (wt(e, H, function () {
                    ct(e, E), ct(e, b), ct(e, I), t.fading = !1
                }, {once: !0}), ct(e, g), t.fading = !0) : ct(e, E), t.tooltipping = !1
            }, 1e3)), this
        }, toggle: function () {
            ...
            var s = [];
            if (nt(e ? [t] : t.querySelectorAll("img"), function (t) {
                i.filter ? i.filter(t) && s.push(t) : s.push(t)
            }), !s.length) return this;
            if (this.images = s, this.length = s.length, this.ready) {
                var o = [];
                if (nt(this.items, function (t, i) {
                    var e = t.querySelector("img"), n = s[i];
                    n ? n.src !== e.src && o.push(i) : o.push(i)
                }), at(this.list, {width: "auto"}), this.initList(), this.isShown) if (this.length) {
                    if (this.viewed) {
                        var n = o.indexOf(this.index);
                        0 <= n ? (this.viewed = !1, this.view(Math.max(this.index - (n + 1), 0))) : lt(this.items[this.index], f)
                    }
            ...
            return t[p] && (this.destroyed = !0, this.ready ? (this.played && this.stop(), i.inline ? (this.fulled && this.exit(), this.unbind()) : this.isShown ? (this.viewing && (this.imageRendering ? this.imageRendering.abort() : this.imageInitializing && this.imageInitializing.abort()), this.hiding && this.transitioning.abort(), this.hidden()) : this.showing && (this.transitioning.abort(), this.hidden()), this.ready = !1, this.viewer.parentNode.removeChild(this.viewer)) : i.inline && (this.delaying ? this.delaying.abort() : this.initializing && this.initializing.abort()), i.inline || pt(t, S, this.onStart), t[p] = void 0), this
        }
    }, Ct = {
        open: function () {
            var t = this.body;
            lt(t, T), t.style.paddingRight = "".concat(this.scrollbarWidth + (parseFloat(this.initialBodyPaddingRight) || 0), "px")
        }, close: function () {
            var t = this.body;
            ct(t, T), t.style.paddingRight = this.initialBodyPaddingRight
        }, shown: function () {
            var t = this.element, i = this.options;
            this.fulled = !0, this.isShown = !0, this.render(), this.bind(), this.showing = !1, et(i.shown) && wt(t, P, i.shown, {once: !0}), !1 !== bt(t, P) && this.ready && this.isShown && !this.hiding && this.view(this.index)
        }, hidden: function () {
            var t = this.element, i = this.options;
            this.fulled = !1, this.viewed = !1, this.isShown = !1, this.close(), this.unbind(), lt(this.viewer, k), this.resetList(), this.resetImage(), this.hiding = !1, this.destroyed || (et(i.hidden) && wt(t, N, i.hidden, {once: !0}), bt(t, N))
            ...
            var i = this.options, e = this.pointers, n = e[Object.keys(e)[0]], s = n.endX - n.startX,
                o = n.endY - n.startY;
            switch (this.action) {
                case h:
                    this.move(s, o);
                ...
                case c:
                    this.zoom(function (t) {
                        var i = st({}, t), h = [];
                        return nt(t, function (r, t) {
                            delete i[t], nt(i, function (t) {
                ...
                case l:
                    ...
                    var a = Math.abs(s);
                    1 < a && a > Math.abs(o) && (this.pointers = {}, 1 < s ? this.prev(i.loop) : s < -1 && this.next(i.loop))
            }
            nt(e, function (t) {
        ...
        return function (t, i, e) {
            ...
            key: "init", value: function () {
                ...
                if (!t[p]) {
                    ...
                    nt(i ? [t] : t.querySelectorAll("img"), function (t) {
                        et(n.filter) ? n.filter.call(e, t) && s.push(t) : s.push(t)
                    ...
                    if (this.body = a, this.scrollbarWidth = window.innerWidth - o.documentElement.clientWidth, this.initialBodyPaddingRight = window.getComputedStyle(a).paddingRight, J(document.createElement(p).style.transition) && (n.transition = !1), n.inline) {
                        ...
                        this.initializing = {
                            ...
                            t.complete ? h() : wt(t, Y, h, {once: !0})
                        })
                    } else wt(t, S, this.onStart = function (t) {
                        var i = t.target;
                        "img" !== i.tagName.toLowerCase() || et(n.filter) && !n.filter.call(e, i) || e.view(e.images.indexOf(i))
                    })
                }
            }
        }, {
                    ...
                    if (this.parent = i, this.viewer = n, this.title = s, this.toolbar = o, this.navbar = a, this.button = r, this.canvas = l, this.footer = n.querySelector(".".concat(p, "-footer")), this.tooltipBox = n.querySelector(".".concat(p, "-tooltip")), this.player = n.querySelector(".".concat(p, "-player")), this.list = n.querySelector(".".concat(p, "-list")), lt(s, h.title ? zt(Array.isArray(h.title) ? h.title[0] : h.title) : k), lt(a, h.navbar ? zt(h.navbar) : k), ut(r, k, !h.button), h.backdrop && (lt(n, "".concat(p, "-backdrop")), h.inline || "static" === h.backdrop || gt(l, K, "hide")), $(h.className) && h.className && h.className.split(U).forEach(function (t) {
                        ...
                        u || lt(o, zt(h.toolbar)), nt(u ? h.toolbar : Z, function (t, i) {
                            ...
                            if (s && (h.zoomable || -1 === d.indexOf(n)) && (h.rotatable || -1 === m.indexOf(n)) && (h.scalable || -1 === f.indexOf(n))) {
                                ...
                                r.setAttribute("role", "button"), lt(r, "".concat(p, "-").concat(n)), et(a) || gt(r, K, n), G(s) && lt(r, zt(s)), -1 !== ["small", "large"].indexOf(o) ? lt(r, "".concat(p, "-").concat(o)) : "play" === n && lt(r, "".concat(p, "-large")), et(a) && wt(r, S, a), c.appendChild(r)
                            }
                        }), o.appendChild(c)
                    } else lt(o, k);
                    if (!h.rotatable) {
                        var g = o.querySelectorAll('li[class*="rotate"]');
                        lt(g, z), nt(g, function (t) {
                            o.appendChild(t)
                        })
                    }
                    if (h.inline) lt(r, x), at(n, {zIndex: h.zIndexInline}), "static" === window.getComputedStyle(i).position && at(i, {position: "relative"}), i.insertBefore(n, t.nextSibling); else {
                        lt(r, w), lt(n, y), lt(n, b), lt(n, k), at(n, {zIndex: h.zIndex});
                        var v = h.container;
                        $(v) && (v = t.ownerDocument.querySelector(v)), (v = v || this.body).appendChild(n)
                    }
                    h.inline && (this.render(), this.bind(), this.isShown = !0), this.ready = !0, et(h.ready) && wt(t, O, h.ready, {once: !0}), !1 !== bt(t, O) ? this.ready && h.inline && this.view(this.index) : this.ready = !1
                }
            }
        }], [{
            key: "noConflict", value: function () {
                return window.Viewer = Lt, e
            }
        }, {
    ...
    return st(Nt.prototype, Tt, Et, It, St, Ct), Nt
});